...
if st.sidebar.button("🔍 전략 수색 개시", type="primary"):
    ...
    try:
        # --- 1. 나라장터 (G2B) ---
        status_st.info(f"📡 [PHASE 1] G2B 수색 중...")
