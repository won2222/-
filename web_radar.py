...
if st.sidebar.button("🔍 전략 수색 개시", type="primary"):
    ...
    kogas_start = (now - timedelta(days=14)).strftime("%Y%m%d") # 가스공사 2주
    ...
    try:
        ...
        try:
            ...
            st.sidebar.error("❌ LH API 서버 응답 오류")
